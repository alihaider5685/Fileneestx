  ...
  return (
    <section className="bg-[#080808] px-6 py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-400">
          We focus on simplicity, speed and privacy. Most tools work instantly
          and are designed to help students, developers, designers, businesses
          and everyday internet users save time and work more efficiently.
        </p>
      </div>
    </section>
  );
